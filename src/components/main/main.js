...
const Main = (props) => {
  return (
    ...
    <div className='virtual-library'>
      <Bookshelf users={props.users} currentBook={props.currentBook} setCurrentBook={props.setCurrentBook} loggedInUser={props.loggedInUser} setLoggedInUser={props.setLoggedInUser} bookshelf={props.bookshelf} setBookshelf={props.setBookshelf} newBookshelf={props.newBookshelf} setNewBookshelf={props.setNewBookshelf} handleBookshelfAdd={props.handleBookshelfAdd} handleBookshelfChange={props.handleBookshelfChange} bookshelfCount={props.bookshelfCount} setBookshelfCount={props.setBookshelfCount}/> 
