...
const Main = (props) => {
  return (
    ...
    <div className='virtual-library'>
      <Bookshelf users={props.users} currentBook={props.currentBook} setCurrentBook={props.setCurrentBook} loggedInUser={props.loggedInUser} setLoggedInUser={props.setLoggedInUser} newBookshelf={props.newBookshelf} setNewBookshelf={props.setNewBookshelf}  bookshelfCount={props.bookshelfCount} setBookshelfCount={props.setBookshelfCount} bookshelf={props.bookshelf} setBookshelf={props.setBookshelf} handleNewAdd={props.handleNewAdd} handleNewAddChange={props.handleNewAddChange}/> 
